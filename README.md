...
- 开发者友好：具备资源审计、Spider脚本的 [热更新调试](https://github.com/kknifer7/CatVodSpider-PC/wiki/JS-Spider%E7%BC%96%E5%86%99#%E4%BA%94%E7%83%AD%E6%9B%B4%E6%96%B0%E8%B0%83%E8%AF%95) 功能，无需自行搭建环境就能实现Spider开发。
...
|:--------:|:--------:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
| Windows  | >=10     | [MSI安装包](https://gh-proxy.org/https://github.com/kknifer7/FreeBox/releases/latest/download/FreeBox_1.8.0.msi) \| [ZIP](https://gh-proxy.org/https://github.com/kknifer7/FreeBox/releases/latest/download/FreeBox_1.8.0_win.zip)                                                                                                                                                                                                                                                           | -                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| macOS    | >=11     | [DMG](https://gh-proxy.org/https://github.com/kknifer7/FreeBox/releases/latest/download/FreeBox_1.8.0_amd64.dmg)                                                                                                                                                                                                                                                                                                                                                                             | [DMG](https://gh-proxy.org/https://github.com/kknifer7/FreeBox/releases/latest/download/FreeBox_1.8.0_arm64.dmg)                                                                                                                                                                                                                                                                                                                                                                             |
| Linux    | -        | [DEB](https://gh-proxy.org/https://github.com/kknifer7/FreeBox/releases/latest/download/FreeBox_1.8.0_amd64.deb) \| [RPM](https://gh-proxy.org/https://github.com/kknifer7/FreeBox/releases/latest/download/FreeBox_1.8.0_amd64.rpm) \| [AppImage](https://gh-proxy.org/https://github.com/kknifer7/FreeBox/releases/latest/download/FreeBox_1.8.0_amd64.AppImage) \| [tar.gz](https://gh-proxy.org/https://github.com/kknifer7/FreeBox/releases/latest/download/FreeBox_1.8.0_amd64.tar.gz) | [DEB](https://gh-proxy.org/https://github.com/kknifer7/FreeBox/releases/latest/download/FreeBox_1.8.0_arm64.deb) \| [RPM](https://gh-proxy.org/https://github.com/kknifer7/FreeBox/releases/latest/download/FreeBox_1.8.0_arm64.rpm) \| [AppImage](https://gh-proxy.org/https://github.com/kknifer7/FreeBox/releases/latest/download/FreeBox_1.8.0_arm64.AppImage) \| [tar.gz](https://gh-proxy.org/https://github.com/kknifer7/FreeBox/releases/latest/download/FreeBox_1.8.0_arm64.tar.gz) |
...
[蓝奏云 - 密码：7ej5](https://wwblv.lanzoul.com/b0139v1k7e)
...
- 导入源：是指将接口链接直接配置进本软件，支持jar和js格式的Spider（type=3），其他类型的Spider后续将按需考虑支持。

- TVBox源：因PC与移动端设备存在环境差异，jar格式的源只支持安卓端。为了**缓解**PC端不能使用安卓端jar的问题，以及为实现后续更多的功能（如弹幕、放映厅、异地同步播放等），本软件可以与特定的 [影视-K](https://github.com/kknifer7/TV-K) 项目一起使用，实现把安卓端的资源投放到PC端来播放。

- 关于TVBox源的更多解释：总的来说，**目前阶段如果你希望在PC端播放安卓端的jar资源，本软件可以帮你省去在电脑上使用手机模拟器的过程（模拟器启动慢、性能差、对4k资源的支持有限），你只需要在同网络环境下的手机后台挂一个影视-K来连接本软件即可**
...
- https://pc.lushunming.qzz.io/json/config.json

- 来自于 [lushunming/AndroidCatVodSpider](https://github.com/lushunming/AndroidCatVodSpider) ，是其他作者的项目，不由本人维护，仅作演示使用，感谢大佬的付出
